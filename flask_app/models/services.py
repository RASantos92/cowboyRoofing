...
class Services:
    ...
    @classmethod
    def update(cls,data):
        query = "UPDATE services SET serv1info = %(serv1info)s,serv2info = %(serv2info)s, serv3info = %(serv3info)s,serv4info = %(serv4info)s, serv4 = %(serv4)s , serv2 = %(serv2)s , serv3 = %(serv3)s , serv1 = %(serv1)s WHERE id = 2"
